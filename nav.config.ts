...
const c: IConfig = {
  // [必填], 请填写您的仓库地址
  gitRepoUrl: 'https://github.com/guixian001/nav',
  ...
  // 您的网站地址，有利于SEO
  homeUrl: 'https://blog.chenguixian.com/nav',
  ...
  footerContent: `
    ...
    <div>Copyright © 2018-2021 https://blog.chenguixian.com/nav, All Rights Reserved</div>
  `,
